...
function runTests() {
    ...
    describe('Test if the files from the "' + dir + '" directory have the expected content', function () {
        ...
        it('"cookie.html" should contain the correct jQuery version in the CDN URL', function (done) {
        ...
        it('"cookie.html" should contain the correct jQuery version in the local URL', function (done) {
